    ...
    <Styled>
        <div>
            ...
            <div style={{textAlign: 'center'}}>
                <a href="https://github.com/gitpod-oss-program/contribute.dev/issues/new?labels=&template=add-project.md&title=Please+add+%3CRepo+URL+here%3E" target="_blank" rel="noopener" className="btn">Add my project 🚀</a>
            </div>
        </div>
    </Styled>
)
